...
train-core:
	python -m rasa_core.train -d domain.yml -s form_stories.md -o forms_bot --epochs 1000 --validation_split 0 --augmentation 5

train-core-debug:
	python -m rasa_core.train -d domain.yml -s form_stories.md -o forms_bot --epochs 1000 --validation_split 0 --augmentation 5 --debug
